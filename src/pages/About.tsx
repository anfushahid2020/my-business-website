...
const About: React.FC = () => {
  return (
    <div style={{ maxWidth: 800, margin: '40px auto', padding: '48px 24px', background: '#0d0d0d', borderRadius: 16, boxShadow: '0 4px 24px rgba(212, 175, 55, 0.08)' }}>
      <h1 style={{ fontSize: 36, fontWeight: 700, color: '#D4AF37', marginBottom: 24, letterSpacing: '0.02em', textAlign: 'center' }}>
        About Us
      </h1>
      ...
      <p style={{ fontSize: 18, color: '#D4AF37', marginBottom: 20, textAlign: 'center' }}>
      ...
      <p style={{ fontSize: 18, color: '#D4AF37', marginBottom: 32, textAlign: 'center' }}>
      ...
      <div style={{ marginTop: 40, textAlign: 'center' }}>
        ...
        />
        <p style={{ fontSize: 16, color: '#D4AF37', marginBottom: 8 }}>
